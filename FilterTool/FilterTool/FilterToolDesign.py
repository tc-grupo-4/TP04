...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frameTotal = QtWidgets.QFrame(self.tab_2)
        ...
        self.horizontalLayout_30.addWidget(self.frameTotal)
        self.paresGroupBoxLayout = QtWidgets.QVBoxLayout()
        self.paresGroupBoxLayout.setObjectName("paresGroupBoxLayout")
        self.GroupBoxPar1 = QtWidgets.QGroupBox(self.tab_2)
        self.GroupBoxPar1.setObjectName("GroupBoxPar1")
        self.gridLayout_25 = QtWidgets.QGridLayout(self.GroupBoxPar1)
        self.gridLayout_25.setObjectName("gridLayout_25")
        self.radioButtonLayoutPar1 = QtWidgets.QVBoxLayout()
        self.radioButtonLayoutPar1.setObjectName("radioButtonLayoutPar1")
        self.radioButtonEtapa1 = QtWidgets.QRadioButton(self.GroupBoxPar1)
        self.radioButtonEtapa1.setObjectName("radioButtonEtapa1")
        self.radioButtonLayoutPar1.addWidget(self.radioButtonEtapa1)
        self.radioButtonEtapa2 = QtWidgets.QRadioButton(self.GroupBoxPar1)
        self.radioButtonEtapa2.setObjectName("radioButtonEtapa2")
        self.radioButtonLayoutPar1.addWidget(self.radioButtonEtapa2)
        self.gridLayout_25.addLayout(self.radioButtonLayoutPar1, 0, 0, 1, 1)
        self.paresGroupBoxLayout.addWidget(self.GroupBoxPar1)
        self.setStagesPushButton = QtWidgets.QPushButton(self.tab_2)
        self.setStagesPushButton.setObjectName("setStagesPushButton")
        self.paresGroupBoxLayout.addWidget(self.setStagesPushButton)
        self.horizontalLayout_30.addLayout(self.paresGroupBoxLayout)
        self.verticalLayout_5.addLayout(self.horizontalLayout_30)
        self.horizontalLayout_29 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_29.setObjectName("horizontalLayout_29")
        self.frameEtapa1 = QtWidgets.QFrame(self.tab_2)
        self.frameEtapa1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameEtapa1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameEtapa1.setObjectName("frameEtapa1")
        self.horizontalLayout_29.addWidget(self.frameEtapa1)
        self.frameEtapa2 = QtWidgets.QFrame(self.tab_2)
        self.frameEtapa2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameEtapa2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameEtapa2.setObjectName("frameEtapa2")
        self.horizontalLayout_29.addWidget(self.frameEtapa2)
        ...
        self.currentApproxComboBox = QtWidgets.QComboBox(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.currentApproxComboBox.sizePolicy().hasHeightForWidth())
        self.currentApproxComboBox.setSizePolicy(sizePolicy)
        self.currentApproxComboBox.setObjectName("currentApproxComboBox")
        self.currentApproxComboBox.addItem("")
        self.currentApproxComboBox.addItem("")
        self.horizontalLayout.addWidget(self.currentApproxComboBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.previewApproxButton.setText(_translate("MainWindow", "Preview Aproximation"))
        ...
        self.GroupBoxPar1.setTitle(_translate("MainWindow", "Par ceros 1"))
        self.radioButtonEtapa1.setText(_translate("MainWindow", "Etapa 1"))
        self.radioButtonEtapa2.setText(_translate("MainWindow", "Etapa2"))
        self.setStagesPushButton.setText(_translate("MainWindow", "Set"))
        self.label_4.setText(_translate("MainWindow", "Approximation"))
        self.currentApproxComboBox.setItemText(0, _translate("MainWindow", "aprozi 1"))
        self.currentApproxComboBox.setItemText(1, _translate("MainWindow", "aprozi 2"))
